...
import 'package:flutter_trans/model/project_content.dart';
...
class _ProjectDetailState extends State<ProjectDetailPage>
  ...
  ///获取项目数据
  void getProjectData() {
    HttpUtils().getProjectContent(curPage, widget.id).then((response) {
      var responseData = ProjectContent.fromJson(response.data);
      setState(() {
        _dataList.addAll(responseData.data.datas);
      });
    });
  }
